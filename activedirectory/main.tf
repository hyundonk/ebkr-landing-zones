...
locals {
    ...
    subnet_prefix_map         	= data.terraform_remote_state.network.outputs.subnet_prefix_map
		subnet_ids_map            	= data.terraform_remote_state.network.outputs.subnet_ids_map
}
